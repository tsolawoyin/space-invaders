...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |tank + invaders + missiles|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

;; now, let's combine tank + missile + invaders
